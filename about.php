...
<section class="about">
   ...
   <div class="flex">
      ...
      <div class="content">
         <h3>Why Satyam Grocery store?</h3>
         <p>1. Quality Assurance: At SatyamGrocery Store, we prioritize quality above all else, ensuring that our products meet the highest standards to satisfy our customers' needs.<br>
...
<section class="reviews">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>"I stumbled upon SatyamGrocery Store online and was pleasantly surprised by their wide variety of products. The website is user-friendly, making my shopping experience a breeze. The delivery was prompt, and the items were fresh. Definitely my go-to for groceries now!".</p>
         <div class="stars">
      ...
      <div class="box">
         ...
         <p>"SatyamGrocery Store is fantastic! I love the convenience of ordering online, and the website is so easy to use. They have everything I need, and the delivery is always on time. Fresh produce and great customer service keep me coming back."</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="box">
         ...
         <p>"I can't recommend SatyamGrocery Store enough! The website is intuitive, and the range of international products is impressive. Freshness is never compromised, and the delivery is lightning-fast. A gem for foodies!"</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
